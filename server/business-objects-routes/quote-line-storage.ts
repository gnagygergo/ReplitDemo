  ...
  async getQuoteLine(
    ...
    const [quoteLine] = await db
      .select({
        ...
        productUnitPrice: quoteLines.productUnitPrice,
        unitPriceCurrency: quoteLines.unitPriceCurrency,
        productUnitPriceOverride: quoteLines.productUnitPriceOverride,
        quoteUnitPrice: quoteLines.quoteUnitPrice,
        unitPriceDiscountPercent: quoteLines.unitPriceDiscountPercent,
        unitPriceDiscountAmount: quoteLines.unitPriceDiscountAmount,
        finalUnitPrice: quoteLines.finalUnitPrice,
        ...
        finalSubtotal: quoteLines.finalSubtotal,
